...
protected:
	...
	GUIImage *paused_overlay_uav1;
	GUIImage *paused_overlay_uav2;
	GUIImage *paused_overlay_uav3;
	GUIImage *paused_overlay_uav4;
	GUIImage *paused_overlay_uav5;
	GUIImage *paused_overlay_uav6;
