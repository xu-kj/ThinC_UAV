...
void GUIImage::clipImage()
{
    ...
    // bottom
    if(viewPort.LowerRightCorner.Y > screen.Height)
    {
        //cout << "  BOTTOM" << endl;
    ...
    // right
    if(viewPort.LowerRightCorner.X > screen.Width)
    {
        //cout << "  RIGHT " << f64(screen.Width - viewPort.LowerRightCorner.X) / f64(width) << endl;
        //cout << endl;
